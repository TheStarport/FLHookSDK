...
public:
	...
	[[NoPlugins]] virtual bool Send_FLPACKET_COMMON_SET_WEAPON_GROUP(uint client, uchar*, int);
	[[NoPlugins]] virtual bool Send_FLPACKET_COMMON_SET_VISITED_STATE(uint client, uchar*, int);
	[[NoPlugins]] virtual bool Send_FLPACKET_COMMON_REQUEST_BEST_PATH(uint client, uchar*, int);
	[[NoPlugins]] virtual bool Send_FLPACKET_COMMON_REQUEST_PLAYER_STATS(uint client, uchar*, int);
	[[NoPlugins]] virtual void unknown_96(uint client, uint, uint, uint);
	[[NoPlugins]] virtual bool Send_FLPACKET_COMMON_REQUEST_GROUP_POSITIONS(uint client, uchar*, int);
	[[NoPlugins]] virtual bool Send_FLPACKET_COMMON_SET_MISSION_LOG(uint client, uchar*, int);
	[[NoPlugins]] virtual bool Send_FLPACKET_COMMON_SET_INTERFACE_STATE(uint client, uchar*, int);
