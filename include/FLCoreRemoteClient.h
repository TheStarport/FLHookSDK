...
public:
	...
	[[NoPlugins]] virtual void unknown_6(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	...
	[[NoPlugins]] virtual void unknown_26(uint iClientID, uint iDunno);
	virtual bool Send_FLPACKET_SERVER_SETADDITEM(uint iClientID, FLPACKET_UNKNOWN& pDunno, FLPACKET_UNKNOWN& pDunno2);
	[[NoPlugins]] virtual void unknown_28(uint iClientID, uint iDunno, uint iDunno2, uint iDunno3);
	...
	[[NoPlugins]] virtual void unknown_36(uint iClientID, uint iDunno, uint iDunno2);
	[[NoPlugins]] virtual void unknown_37(uint iClientID, uint iDunno, uint iDunno2);
	...
	[[NoPlugins]] virtual void unknown_44(uint iClientID, uint iDunno, uint iDunno2);
	...
	[[NoPlugins]] virtual void unknown_63(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	virtual bool Send_FLPACKET_SERVER_DAMAGEOBJECT(uint iClientID, uint iObj, DamageList& dmlist);
	...
	[[NoPlugins]] virtual void unknown_68(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	...
	[[NoPlugins]] virtual void unknown_70(uint iClientID, uint iDunno);
	virtual bool Send_FLPACKET_SERVER_SET_MISSION_MESSAGE(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	[[NoPlugins]] virtual void unknown_72(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	virtual bool Send_FLPACKET_SERVER_SETMISSIONOBJECTIVES(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual void unknown_74(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	[[NoPlugins]] virtual void unknown_75(uint iClientID, uint iDunno);
	virtual bool Send_FLPACKET_SERVER_MARKOBJ(uint iClientID, uint iDunno, uint iDunno2);
	[[NoPlugins]] virtual void unknown_77(uint iClientID, uint iDunno);
	virtual bool Send_FLPACKET_SERVER_SETCASH(uint iClientID, uint iCash);
	[[NoPlugins]] virtual void unknown_79(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual void unknown_80(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual void unknown_81(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual void unknown_82(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual void unknown_83(uint iClientID, char* szDunno);
	virtual bool Send_FLPACKET_SERVER_REQUEST_RETURNED(uint iClientID, uint iShipID, uint iFlag, uint iDunno3, uint iDunno4);
	[[NoPlugins]] virtual void unknown_85(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	[[NoPlugins]] virtual void unknown_86(uint iClientID, uint iDunno, uint iDunno2, uint iDunno3);
	...
	[[NoPlugins]] virtual void unknown_89(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	[[NoPlugins]] virtual void unknown_90(uint iClientID);
	[[NoPlugins]] virtual void unknown_91(uint iClientID, uint iDunno);
	...
	[[NoPlugins]] virtual void unknown_96(uint iClientID, uint iDunno, uint iDunno2, uint iDunno3);
	...
	[[NoPlugins]] virtual void unknown_100(uint iClientID, uint iDunno, uint iDunno2);
	[[NoPlugins]] virtual void unknown_101(uint iClientID, FLPACKET_UNKNOWN& pDunno);
	[[NoPlugins]] virtual void unknown_102(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual void unknown_103(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual void unknown_104(uint iClientID, uint iDunno, uint iDunno2);
	[[NoPlugins]] virtual void unknown_105(uint iClientID, uint iDunno, uint iDunno2);
	[[NoPlugins]] virtual void unknown_106(uint iClientID, uint iDunno, uint iDunno2);
	[[NoPlugins]] virtual void unknown_107(uint iClientID, uint iDunno, uint iDunno2);
	virtual bool Send_FLPACKET_COMMON_PLAYER_TRADE(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual void unknown_109(uint iClientID, uint iDunno);
	...
	[[NoPlugins]] virtual void unknown_112(uint iClientID, uint iDunno);
	...
	[[NoPlugins]] virtual void unknown_121(uint iClientID, uint iDunno);  // formation sth?
	virtual bool Send_FLPACKET_SERVER_FORMATION_UPDATE(uint iClientID, uint iShipID, Vector& vFormationOffset);
	[[NoPlugins]] virtual void unknown_123(uint iClientID, uint iDunno, uint iDunno2, uint iDunno3, uint iDunno4, uint iDunno5, uint iDunno6);
	[[NoPlugins]] virtual void unknown_124(uint iClientID);
	[[NoPlugins]] virtual void unknown_125(uint iClientID, uint iDunno);
	[[NoPlugins]] virtual int unknown_126(char* szUnknown);
};
