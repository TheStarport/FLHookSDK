...
struct IObjInspect : public IObjInspectImpl
{
...
struct GameObjectAffect
{
    public:
        virtual void sub_6CEF3A0_(); // ret -3
        virtual void sub_6CEF3A0_0(); //ret -3
        virtual void sub_6CEF3A0_1(); //ret -3
        virtual void sub_6CEF3A0_2(); //ret -3
        virtual void sub_6CEF340_0(int); // ret -8
        virtual void sub_6CEF340_1(int); // ret -8
        virtual void sub_6CEF340_2(int); // ret -8
        virtual void sub_6CEF340_3(int); // ret -8
        virtual void ret0();
        virtual void sub_6CEF340_4(int); // ret -8
        virtual void sub_6CEF340_5(int); // ret -8
        virtual void sub_6CEF340_6(int); // ret -8
        virtual void sub_6CEF340_7(int); // ret -8
        virtual void sub_6CEF380_0(int, int, int, int); // ret -3
        virtual void sub_6CEF370_0(int, int, int); // ret -3
        virtual void sub_6CEF370_1(int, int, int); // ret -3
        virtual void sub_6CEF370_2(int, int, int); // ret -3
        virtual void sub_6CEF380_1(int, int, int, int); // ret-3
        virtual void sub_6CEF370_3(int, int, int); // ret -3
        virtual void sub_6CEF370_4(int, int, int); // ret -3
        virtual void sub_6CEF370_5(int, int, int); // ret -3
        virtual void sub_6CEF350_3();	//ret -3
        virtual void sub_6CEF370_6(int, int, int); // ret-3
        virtual void sub_6CEF360(int, int, int, int, int); //ret-3
        virtual void sub_6CEF370_7(int, int, int); // ret-3
        virtual void sub_6CEF380_2(int, int, int, int); // ret-3
        virtual void retminus3();
        virtual void sub_6CEF350_4(); //ret -3
        virtual void sub_6CEF3A0_5(); //ret -3
        virtual void sub_6CEF3A0_6(); //ret -3
};

struct GameObjectDestructor
{
    virtual struct GameObject* DestroyGameObject(bool deallocate);
};
...
struct ShipAffect
{
    public:
        ...
        virtual void sub_6CE6F60(ushort gunSId, uint target, ushort targetSId, int flag); // 68 setTarget?
        virtual void sub_6D02340();                                 // 72
        virtual void sub_6CE70B0(ushort SId, int dunno, int flag);  // 76 something about strafing/thrusting
        virtual void sub_6D02410();                                 // 80
        virtual void sub_6D02500();                                 // 84
        virtual void use_item(ushort SId, uint amount, int unused); // 88 sub_6CE7210
...
struct ShipDestructor
{
    virtual struct Ship* DestroyGameObject(bool deallocate);
};
...
struct SolarAffect
{
    public:
        ...
        virtual void sub_6CEF340_6(int); // ret -8
        virtual void sub_6CEF340_7(int); // ret -8
        virtual void sub_6CE68A0(int, int, int, int); // fire guns?
        virtual void sub_6CEF370_0(int, int, int); // ret -3
        virtual int  sub_6CE6D80(ushort sId, int, int); // something about Tractoring?
        virtual int  sub_6CE6BA0(ushort sId, int, int);              // 64 something about Tractoring?
        virtual void sub_6CE6F60(ushort gunSId, uint target, ushort targetSId, uint flag); // 68 setTarget?
        virtual void sub_6CEF370_3(int, int, int); // ret -3
        virtual void sub_6CE70B0(ushort SId, int dunno, int flag);  // 76 something about strafing/thrusting
        virtual void sub_6CEF370_5(int, int, int); // ret -3
        virtual void sub_6CEF350_3();	//ret -3
...
struct SolarDestructor
{
    virtual struct Solar* DestroyGameObject(bool deallocate);
};
...
struct IMPORT IObjInspectImpl
{
    public:
        ...
        virtual CObject* cobject() const;                                                                               // 336
};

struct GameObject : public IObjInspectImpl, public GameObjectAffect
{
...
struct CounterMeasure : public GameObject // TODO: add missing inherits
{
...
struct Bullet : public GameObject // TODO: add missing inherits
{
    //TODO: Fields and methods
    // lots of fields but not much use filling it in
};

struct Loot : public GameObject // TODO: add missing inherits
{
...
struct EqObj : public GameObject // TODO: add missing inherits
{
...
struct Ship : public EqObj, public ShipAffect // TODO: add missing inherits
{
...
struct Solar : public EqObj, public SolarAffect // TODO: add missing inherits
{
