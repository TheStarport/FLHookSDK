...
class CEGun : public CELauncher
{
  public:
    ...
    IMPORT FireResult Fire(const Vector&) override;
    IMPORT void ConsumeFireResources() override;
    IMPORT void ComputeLaunchInfo_OneBarrel(ProjLaunchInfo&, int, const Vector&) const override;
