...
class IMPORT ClipNode : public RDLNode
{
  public:
    ...
    operator ClipNode*() override;
    operator const ClipNode*() const override;
...
class IMPORT NullNode : public RDLNode
{
  public:
    ...
    operator NullNode*() override;
    operator const NullNode*() const override;
};
...
class IMPORT StyleNode : public RDLNode
{
  public:
    ...
    operator class StyleNode*() override;
    operator class StyleNode const*() const override;
...
class IMPORT ParagraphNode : public RDLNode
{
  public:
    ...
    operator class ParagraphNode*() override;
    operator class ParagraphNode const*() const override;
};
...
class IMPORT TextPtrNode : public RDLNode
{
  public:
    ...
    operator TextPtrNode*() override;
    operator const TextPtrNode*() const override;
...
class IMPORT JustifyNode : public RDLNode
{
  public:
    ...
    operator JustifyNode*() override;
    operator const JustifyNode*() const override;
...
class IMPORT PositionNode : public RDLNode
{
  public:
    ...
    operator PositionNode*() override;
    operator const PositionNode*() const override;
...
class IMPORT AttribStackNode : public RDLNode
{
  public:
    ...
    operator AttribStackNode*() override;
    operator const AttribStackNode*() const override;
...
class IMPORT RDLReNode : public RDLNode
{
  public:
    ...
    operator RDLReNode*() override;
    operator const RDLReNode*() const override;
};
