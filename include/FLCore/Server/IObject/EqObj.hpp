...
struct EqObj : public GameObject
{
    ...
    virtual void damage_or_sethitpts_eq_by_hardpoint(const char* hardpoint, f32 damage, bool damageOrSetHitPoints, DamageList* dmg); // 460
    virtual void destroy_eq_by_hardpoint(const char* hardpoint, DamageEntry::SubObjFate fate, DamageList* dmg);                      // 464
    ...
    virtual bool light_fuse(unsigned dunno, const Id& fuseId, u16 sId, f32 radius, f32 fuseLifetime); // 484 sub_6D01A90
    ...
    virtual bool process_explosion_damage_shield_bubble(ExplosionDamageEvent* explosion,
    ...
    virtual bool damage_shield_direct(CEShield* target, f32 dmg, DamageList* dmgList); // NakedDamageHit2        //532 sub_6CEA740
    virtual bool damage_col_grp(CArchGroup*, f32, DamageList*);                        // 536 sub_6CEAA80
    virtual bool damage_energy(f32 energyDamage, DamageList* dmgList); // deal energy damage                      //540 sub_6CEAFC0
