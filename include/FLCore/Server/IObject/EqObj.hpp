...
struct EqObj : public GameObject
{
        ...
        virtual void damage_or_sethitpts_eq_by_hardpoint(const char* hardpoint, float damage, bool damageOrSetHitPoints, DamageList* dmg); //460
        ...
        virtual bool light_fuse(unsigned dunno, const Id& fuseId, unsigned short sId, float radius, float fuseLifetime);                     // 484 sub_6D01A90
        virtual bool unlight_fuse(const Id& fuseId, unsigned short sid, float lifeTime);                                                 // 488 sub_6CEC7F0
