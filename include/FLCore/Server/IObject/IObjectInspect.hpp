...
struct IObjInspectImpl
{
    public:
        ...
        IMPORT virtual int get_dock_hardpoints(int dockIndex, TERMINAL_TYPE* dockType, Transform* dockMount, Transform* dockPoint1, Transform* dockPoint2,
...
struct IObjAffect
{
        ...
        virtual int go_tradelane(const IObjInspect* startRing, const IObjInspect* nextRing, IObjRW* jumpingIObj, bool unk1, f32 unk2); // 100
