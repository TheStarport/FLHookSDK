...
struct IClientImpl
{
  public:
    ...
    [[CallInner, NoLog, NoPlugins]]
    virtual bool Startup(u32, u32);
    [[NoPlugins]]
    virtual void nullsub(u32);
    [[NoPlugins]]
    ...
    virtual bool Send_FLPACKET_SERVER_SENDCOMM(u32 client, u32 senderObjId, u32 receiverObjId, u32 voice, u32 head, u32 body, u32 leftHand,
                                               u32 rightHand, u32 accessory1, u32 accessory2, u32 accessory3, u32 accessory4,
                                               u32 accessory5, u32 accessory6, u32 accessory7, u32 accessory8, u32 accessories, u32 name,
                                               u32* lines, u32 lineCount, u32 commType, f32 radioSilenceAfter, bool global);
    [[NoPlugins]]
